    	...
    	<div class="container footer">
         ...
         <div class="copyright-wrapper">
        	<div class="container">
            	 ...
            	 <div class="design-by"><?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','flower-shop-lite');?><a href="<?php echo esc_url('https://www.sktthemes.org/shop/free-shop-wordpress-theme/');?>" rel="noopener" target="_blank">
